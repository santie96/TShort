                ...
                <div className="mx-auto max-w-7xl px-4 pb-8 sm:px-6 lg:px-8 lg:py-15">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        ...
                        <div className="flex flex-col gap-4 p-2">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col gap-4">
                                    <div className="flex w-full justify-between items-center">
                                        ...
                                        {showSale ? (
                                            <div className="flex items-center gap-2 font-text">
                                                <span className="font-medium line-through text-black">{OriginalPrice}€</span>
                                                <div className="flex items-center gap-2 rounded bg-red-500/20 px-2 py-1">
                                                    <span className="font-medium text-xl text-red-600">{priceTot}€</span>
                                                    <span className="font-medium text-red-600">-{prodotto.sale}%</span>
                                                </div>
                                            </div>
                                        ) : (
                                    ...
                                    <div className="flex w-full justify-between items-center">
                                        ...
                                        <p className="text-[0.9rem] text-balance">{prodotto.description}</p>
                            ...
                            {/* pulsante */}
                            <div className=" flex flex-1 items-end md:p-5 lg:p-5 w-full justify-center">

                                <div className="w-full 
                                py-2 bg-[#C47048] text-[#FDFCF8] rounded-full cursor-pointer flex justify-center items-center text-base font-semibold hover:bg-">
                            ...
                            <div className="h-auto rounded-2xl border border-[#DDDAD5] bg-[#F6F4F0] font-text">
                                <div className="flex flex-col gap-3 p-4 ">
                                    ...
                                    <Link className="flex items-center justify-between">
                                        <p className="font-semibold flex items-center gap-1"><TbTruckDelivery /> {`Spedizione Gratuita`} <span className="text-[0.9rem] font-normal">{`(per ordini > 40€)`}</span></p>
                                    ...
                                    <Link className="flex items-center justify-between"><p className="font-semibold flex items-center gap-1"><BiPackage /> {`Resi gratuiti entro 30 giorni`}</p>
                                        <IoIosArrowRoundForward className="text-xl" />
                                    </Link>
                                    ...
                                    <Link className="flex items-center justify-between">
                                        <p className="font-semibold flex items-center gap-1"><MdCreditScore /> Pagamenti sicuri - Tutela della privacy</p>
                                        <IoIosArrowRoundForward className="text-xl" />
                                    </Link>
                            ...
                            {/* Recensioni */}
                            <div className="rounded-2xl border border-[#DDDAD5] bg-[#F6F4F0] p-4">
