...
import imgHeroEssentials from "../../../img/hero/Summer-Essentials.webp"

function HeroEssentials() {
  return (
    <section className={`relative max-[769px]:bg-bottom bg-cover bg-no-repeat min-h-[55vh] md:min-h-140`} style={{ backgroundImage: `url(${imgHeroEssentials})` }}>
