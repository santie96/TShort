        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-0 py-10 md:py-16 space-y-8 md:space-y-12">
          ...
          <section className="space-y-2 md:space-y-4">
            ...
            <p className="--font-text text-[#211D1A] text-[0.875rem] leading-7">
              ...
              tablet o smartphone), dove vengono memorizzati per essere poi ritrasmessi agli stessi siti in occasione di
              visite successive. I cookie svolgono funzioni diverse: consentono di navigare in modo efficiente tra le
              pagine, memorizzare le preferenze dell'utente e, più in generale, migliorare l'esperienza di navigazione.
              Possono inoltre contribuire a garantire che gli annunci pubblicitari visualizzati online siano più
          ...
          <section className="space-y-2 md:space-y-4">
            ...
            <p className="--font-text text-[#211D1A] text-[0.875rem] leading-7">
              ...
              ad esempio, i cookie di sessione, i cookie di autenticazione e quelli utilizzati per bilanciare il carico
              dei server.
            </p>
          </section>
          ...
          <section className="space-y-2 md:space-y-4">
            ...
            <p className="--font-text text-[#211D1A] text-[0.875rem] leading-7">
              ...
              previsto dalla normativa vigente, l'utilizzo di questi cookie è subordinato al consenso dell'utente, salvo
              il caso in cui vengano configurati in modalità che ne escludono l'identificabilità individuale.
            </p>
          </section>
          ...
          <section className="space-y-2 md:space-y-4">
            ...
            <p className="--font-text text-[#211D1A] text-[0.875rem] leading-7">
              ...
              accedendo al pannello di gestione del consenso, disponibile tramite l'apposito banner presentato alla
              prima visita del sito o, in seguito, attraverso il link dedicato presente in calce a ogni pagina del sito.
              Le modifiche apportate saranno applicate immediatamente e avranno effetto per le navigazioni successive.
            </p>
          </section>
